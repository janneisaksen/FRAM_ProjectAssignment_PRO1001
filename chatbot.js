/**
 * Controls the chat on the chat page.
 * Sends messages to an external endpoint if one is set.
 * Falls back to local keyword-based replies if no endpoint is available.
 */
